...
located in .trae/skills/live2d-master-agent/config_api.py.
...
os.chdir(_SKILL_DIR)
sys.argv[0] = "config_api.py"
sys.path.insert(0, _SKILL_DIR)

with open(os.path.join(_SKILL_DIR, "config_api.py"), "r", encoding="utf-8") as _f:
    _code = _f.read()
exec(compile(_code, os.path.join(_SKILL_DIR, "config_api.py"), "exec"), {"__name__": "__main__", "__file__": os.path.join(_SKILL_DIR, "config_api.py")})
