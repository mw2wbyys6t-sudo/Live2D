...
Usage:
    python create_test_image.py                    # default: test_character.png (512x512)
    python create_test_image.py -o my_char.png     # custom output filename
...
def create_test_character(size: int = 512, output: str = "test_character.png"):
    ...
    print(f"  python live2d_layer_v6.py {output} test_output")
    return abs_path
...
def main():
    ...
    parser.add_argument(
        "-o", "--output", default="test_character.png", help="Output filename (default: test_character.png)"
    )
    parser.add_argument(
