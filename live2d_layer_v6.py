...
located in .trae/skills/live2d-master-agent/live2d_layer_v6.py.
...
with open(os.path.join(_SKILL_DIR, "live2d_layer_v6.py"), "r", encoding="utf-8") as _f:
    _code = _f.read()
exec(compile(_code, os.path.join(_SKILL_DIR, "live2d_layer_v6.py"), "exec"), {"__name__": "__main__", "__file__": os.path.join(_SKILL_DIR, "live2d_layer_v6.py")})
