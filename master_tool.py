...
with open(os.path.join(_SKILL_DIR, "master_tool.py"), "r", encoding="utf-8") as _f:
    _code = _f.read()
exec(compile(_code, os.path.join(_SKILL_DIR, "master_tool.py"), "exec"), {"__name__": "__main__", "__file__": os.path.join(_SKILL_DIR, "master_tool.py")})
