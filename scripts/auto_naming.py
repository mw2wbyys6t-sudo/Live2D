...
located in .trae/skills/live2d-master-agent/scripts/auto_naming.py.
...
os.chdir(_SKILL_DIR)
sys.argv[0] = os.path.join("scripts", "auto_naming.py")
sys.path.insert(0, _SKILL_DIR)

_script_path = os.path.join(_SKILL_DIR, "scripts", "auto_naming.py")
