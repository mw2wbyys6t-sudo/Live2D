...
located in .trae/skills/live2d-master-agent/scripts/parameter_designer_enhanced.py.
...
os.chdir(_SKILL_DIR)
sys.argv[0] = os.path.join("scripts", "parameter_designer_enhanced.py")
sys.path.insert(0, _SKILL_DIR)

_script_path = os.path.join(_SKILL_DIR, "scripts", "parameter_designer_enhanced.py")
