...
located in .trae/skills/live2d-master-agent/install_comfyui_advanced.py.
...
os.chdir(_SKILL_DIR)
sys.argv[0] = "install_comfyui_advanced.py"
sys.path.insert(0, _SKILL_DIR)

with open(os.path.join(_SKILL_DIR, "install_comfyui_advanced.py"), "r", encoding="utf-8") as _f:
    _code = _f.read()
exec(compile(_code, os.path.join(_SKILL_DIR, "install_comfyui_advanced.py"), "exec"), {"__name__": "__main__", "__file__": os.path.join(_SKILL_DIR, "install_comfyui_advanced.py")})
