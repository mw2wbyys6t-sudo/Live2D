...
exports.ComfyUIConnector = void 0;
...
class ComfyUIConnector {
    ...
    async uploadImage(imagePath, imageType = 'input') {
        try {
    ...
    async getQueueInfo() {
        try {
            ...
            pendingPrompts.forEach((item, index) => {
                items.push({
                    prompt_id: item.prompt_id,
                    status: 'pending',
...
exports.ComfyUIConnector = ComfyUIConnector;
//# sourceMappingURL=comfyui.connector.js.map