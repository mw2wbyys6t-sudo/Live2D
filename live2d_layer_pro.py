...
located in .trae/skills/live2d-master-agent/live2d_layer_pro.py.
...
os.chdir(_SKILL_DIR)
sys.argv[0] = "live2d_layer_pro.py"
sys.path.insert(0, _SKILL_DIR)

with open(os.path.join(_SKILL_DIR, "live2d_layer_pro.py"), "r", encoding="utf-8") as _f:
    _code = _f.read()
exec(compile(_code, os.path.join(_SKILL_DIR, "live2d_layer_pro.py"), "exec"), {"__name__": "__main__", "__file__": os.path.join(_SKILL_DIR, "live2d_layer_pro.py")})
